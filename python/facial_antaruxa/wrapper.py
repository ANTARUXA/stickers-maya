...
class Wrapper:
    ...
    def create_system(self, base_string, name_string, group_name_array):
        ...
        Args:
            wrapper (Wrapper): Wrapper to execute operations, will be replaced by an instance of class
    ...
    def create_utility_node(
        self, node_type, node_name, connections=None, attributes=None, *args, **kwargs
    ):
